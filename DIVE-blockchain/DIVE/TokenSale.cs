...
namespace Neo.SmartContract
{
    public class TokenSale : Framework.SmartContract
    {
        ...
        public static bool SetVestingPeriodForAddress(byte[] address, BigInteger tokensPurchased) // Deprecated
        {
            if (!DIVE.DIVE.useTokenVestingPeriod())
            {
                return false;
            }
            ...
            object[] vestingOne = new object[] { 250000, 7257600 }; // Deprecated
            object[] vestingTwo = new object[] { 5000000, 14515200 }; // Deprecated
